...
contract Oracle {
    ...
    //event that triggers off-chain oracles
    event NewRequest (
        uint id,
        string urlToQuery,
    ...
    function createRequest (string memory _urlToQuery, string memory _attributeToFetch) public
    {
        ...
        // Hardcoded off-chain oracles addresses
        r.quorum[address(0x000000000000000000000000000000000000dEaD)] = 1;
        r.quorum[address(0x000000000000000000000000000000000000dEaD)] = 1;
        r.quorum[address(0x000000000000000000000000000000000000dEaD)] = 1;

        // launch an event to be detected by off-chain oracles
        emit NewRequest (
            currentId,
            _urlToQuery,
            _attributeToFetch
    ...
    function updateRequest (uint _id, string memory _valueRetrieved ) public
    {
        ...
        //check if oracle is in the list of trusted oracles and if the oracle hasn't voted yet
